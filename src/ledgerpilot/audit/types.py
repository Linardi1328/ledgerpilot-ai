...
class AuditEventType(StrEnum):
    ...
    RECONCILIATION_REVIEW_CREATED = "reconciliation_review_created"
    RECONCILIATION_CANDIDATE_SELECTED = "reconciliation_candidate_selected"
    RECONCILIATION_DISPUTED = "reconciliation_disputed"
    RECONCILIATION_DISPUTE_REOPENED = "reconciliation_dispute_reopened"
    RECONCILIATION_APPROVED = "reconciliation_approved"
    RECONCILIATION_MARKED_UNMATCHED = "reconciliation_marked_unmatched"
